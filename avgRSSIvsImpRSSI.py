...
listOfStrings2 = [-50 for i in range(180)]
...
plt.plot(x, distance, color="blue", label="Distance at Direct RSSI")
plt.plot(x, distance1, color="red", label="Distance at Improved RSSI")
plt.plot(x, distance2, color="yellow", label=" Distance at Improved and Smooth RSSI")
...
plt.plot(x,SNR_margin, color="blue", label="Direct SNR Margin")
